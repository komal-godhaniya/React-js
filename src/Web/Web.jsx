    ...
    return (
        ...
        <div>
            ...
            <div id="page">
                ...
                <header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style={{ background: "url('images/hero_1.jpeg')", height:"600px" , backgroundRepeat:"no-repeat",backgroundSize:"cover"}} data-stellar-background-ratio="0.5">
                    <div class="overlay"></div>
                    <div class="container" >
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="display-t js-fullheight" style={{marginTop:"230px"}}>
                ...
                {/* <div id="fh5co-featured-testimony" class="fh5co-section" style={{border:"1px solid white"}}>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 fh5co-heading">
                                <h2>Testimony</h2>
                            ...
                            <div class="col-md-7" data-animate-effect="fadeInRight">
                                <blockquote>
                            ...
                            <div class="col-md-6 col-md-push-1">
                                <aside id="fh5co-slider-wrwap">
                                    <div class="flexslider">
                                        <ul class="slides">
                                            <li style={{ background: "url('images/gallery_7.jpeg') "}}>
                                            ...
                                            <li style={{ background: "url('images/gallery_6.jpeg')" }}>
                                                <div class="overlay-gradient"></div>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
                                            ...
                                            <li style={{ background: "url('images/gallery_5.jpeg')" }}>
                                                <div class="overlay-gradient"></div>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="fh5co-blog">
                                    <a href="#" class="blog-bg" style={{ background: "url('images/gallery_1.jpeg') "}}></a>
                                    <div class="blog-text">
                            ...
                            <div class="col-md-4">
                                <div class="fh5co-blog">
                                    <a href="#" class="blog-bg" style={{ background: "url('images/gallery_2.jpeg')" }}></a>
                                    <div class="blog-text">
                                        <span class="posted_on">Feb. 15th 2016</span>
                            ...
                            <div class="col-md-4">
                                <div class="fh5co-blog">
                                    <a href="#" class="blog-bg" style={{ background: "url('images/gallery_3.jpeg')" }}></a>
                                    <div class="blog-text">
                                        <span class="posted_on">Feb. 15th 2016</span>
                ...
                <div id="fh5co-started" class="fh5co-section" style={{ background: "url('images/hero_1.jpeg')" }} data-stellar-background-ratio="0.5">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
